...
form.addEventListener("submit", (e) => {
    ...
    const publicoAlvo = value("publicoAlvo");
    ...
    // Renderiza bloco de informações (sem endereço físico)
    let infoHTML = `
    ...
    gerarDescricao(curso, descricaoCurso, formatarDataISOparaBR(prazoInscricao), dataInicio, dataFim, horario, cidadeUfValor, codigoFip, prerequisito, publicoAlvo);
